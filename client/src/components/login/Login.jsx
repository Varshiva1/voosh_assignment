...
const Login = () => {
  ...
  return (
    <div className={styles.login_container}><h2>Login</h2>
    <form className={styles.login_form} onSubmit={handleSubmit}>
        <label>
            Phone Number: <input type="number" maxLength={10} required onChange={(e)=>setPhoneNo(e.target.value)}/>
        </label>
        <label>
...
{error && <p>wrong password or phone number already exist</p>}
    ...
    <p>If you don't have an account then, <Link to="/add-user">
    Signup
    </Link>
    </p>
    </div>
